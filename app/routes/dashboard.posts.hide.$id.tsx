    ...
    return (
        <div className="h-full flex items-center justify-center">
            <Card className="w-full max-w-md border-0 shadow-md">
                <CardHeader>
                    <CardTitle className="text-md text-amber-600 flex items-center gap-2">
                ...
                <CardContent className="space-y-4">
                    <p className="text-sm text-gray-600">
                        Are you sure you want to hide this post by{" "}
                    ...
                    <p className="text-xs text-gray-500">
                        This post will no longer be visible to customers or models. The author can still see it in their posts list.
                    </p>
