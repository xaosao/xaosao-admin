                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-orange-800">
                                            Transaction Cancelled by {transaction.customerHidden ? "Customer" : "Model"}
                                        </h4>
                                        <p className="text-sm text-orange-700 mt-1">
                                            This transaction was cancelled/deleted by the {transaction.customerHidden ? "customer" : "model"}. You can still reject it with a reason.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
